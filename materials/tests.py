...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(name="Javatest", description="Джаватест 1", owner=self.user)
        self.lesson = Lesson.objects.create(name="Javatest", description="Джаватест 1.1", course=self.course,
                                            owner=self.user)
    ...
    def test_lesson_update(self):
        ...
        self.assertEqual(
            data.get("name"), "Джаватест - начало 1.1"
        )
...
class SubscriptionTestCase(APITestCase):
    def setUp(self):
        ...
        self.course = Course.objects.create(name="Python", description="Python 1", owner=self.user)
        self.client.force_authenticate(user=self.user)
